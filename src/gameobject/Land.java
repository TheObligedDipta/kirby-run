...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land4 = Resource.getResouceImage("data/land4.png");
	...
	public void draw(Graphics g) {
		for(ImageLand imgLand : listLand) {
			g.drawImage(imgLand.image, (int) imgLand.posX-1, LAND_POSY, null);
		}
	}
